    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        if (!options.queryParameters) {
          ...
          queryString = _querystring.default.stringify(options.queryParameters);
          response = yield (_axios || _load_axios()).default.request(_extends({}, reqOptions, { params: queryString }));
        }
