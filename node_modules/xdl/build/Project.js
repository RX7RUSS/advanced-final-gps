...
let _uploadArtifactsAsync = (() => {
  var _ref8 = _asyncToGenerator(function* ({
    ...
    (0, (_FormData2 || _load_FormData2()).append)(formData, 'expJson', JSON.stringify(exp));
    (0, (_FormData2 || _load_FormData2()).append)(formData, 'iosBundle', iosBundle, { filename: 'iosBundle' });
    (0, (_FormData2 || _load_FormData2()).append)(formData, 'androidBundle', androidBundle, {
    ...
    yield Promise.all((_lodash || _load_lodash()).default.chunk(missing, 5).map((() => {
      var _ref18 = _asyncToGenerator(function* (keys) {
        ...
        keys.forEach(function (key) {
          ...
          (0, (_FormData2 || _load_FormData2()).append)(formData, key, _fs.default.createReadStream(paths[key]), {
            filename: paths[key]
          });
        });
...
function _load_FormData2() {
  return _FormData2 = require('./tools/FormData');
}
